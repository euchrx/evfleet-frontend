...
export function VehiclesPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 overflow-hidden bg-slate-900/50 p-4">
          <div className="relative mx-auto my-4 flex h-[calc(100vh-2rem)] w-full max-w-5xl flex-col rounded-2xl bg-white shadow-2xl md:my-6 md:h-[calc(100vh-3rem)]">
